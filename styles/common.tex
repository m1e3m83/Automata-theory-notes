...
% ----------Table of Contents--------------
% Customize the font and color of the TOC
%\renewcommand{\cftsecfont}{\color{black}\normalfont\bfseries} % Section font
%\renewcommand{\cftsecleader}{\color{black}\bfseries\cftdotfill{\cftdotsep}} % Section leaders (dots)
%\renewcommand{\cftsecpagefont}{\color{black}\normalfont} % Section page numbers
%
